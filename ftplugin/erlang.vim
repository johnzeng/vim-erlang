...
autocmd VimEnter * call StartWranglerServer()
...
nmap <leader>ae :call ErlangExtractFunction("n")<ENTER>
vmap <leader>ae :call ErlangExtractFunction("v")<ENTER>
...
map <leader>af :call ErlangRenameFunction()<ENTER>

function! ErlangRenameVariable()
    call ErlangRename("var")
endfunction
map <leader>av :call ErlangRenameVariable()<ENTER>

function! ErlangRenameModule()
    call ErlangRename("mod")
endfunction
map <leader>am :call ErlangRenameModule()<ENTER>
...
nmap <leader>at :call ErlangTupleFunArgs("n")<ENTER>
vmap <leader>at :call ErlangTupleFunArgs("v")<ENTER>
